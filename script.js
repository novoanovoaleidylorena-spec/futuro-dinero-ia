...
let formato = new Intl.NumberFormat('es-CO',{style:'currency',currency:'COP'})

document.getElementById("resultado").innerHTML=

"Ahorrarás "+formato.format(ahorro)+" al mes<br>Lograrás tu meta en <b>"+meses+" meses</b>"

let progreso = (ahorro/costo)*100

if(progreso>100) progreso=100

document.getElementById("progreso").style.width = progreso+"%"

crearGrafico(meses,ahorro)

}

function crearGrafico(meses, ahorro){
